...
public class DTOEncryptor {
    ...
    public static <T> void encryptAllDTO(T registerDTO, SecretKey secretKey) throws Exception {
        Class<?> dtoClass = registerDTO.getClass();
        Field[] fields = dtoClass.getDeclaredFields();
    ...
    public static <T> void decryptAllDTO(T registerDTO, SecretKey secretKey) throws Exception {
        Class<?> dtoClass = registerDTO.getClass();
        Field[] fields = dtoClass.getDeclaredFields();
        for (Field field : fields) {
                field.setAccessible(true);
